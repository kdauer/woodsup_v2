...
const Protection = ({t}) => {
    return (
      ...
      <p>
        ...
        Protection). Ein Widerruf Ihrer bereits erteilten Einwilligung ist jederzeit
      ...
      <p>
        ...
        Grundlage von Art. 6 Abs. 1 lit. f Protection. Als Betreiber dieser Website
      ...
      <p>
        ...
        lit. f Protection. Als Betreiber dieser Website haben wir ein berechtigtes
        Interesse an der optimalen Darstellung und Übertragung unseres
        Webauftritts.
      </p>
      <p>
        Das Unternehmen Google ist für das us-europäische
        Datenschutzübereinkommen "Protection Shield" zertifiziert. Dieses
...
export default withTranslation('common')(Protection)